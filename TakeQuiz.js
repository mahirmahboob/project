...
//if (tag === "genre"){
  // if (this.state.recs.get(tag) === 'realistic'){
  //   let elem = document.getElementById('hide1')
  //   let gen = document.getElementById('realistic')
  //   genres(elem,gen)
  // }
  // if (this.state.recs.get(tag) === 'science fiction'){
  //   let elem = document.getElementById('hide1')
  //   let gen = document.getElementById('science fiction')
  //   genres(elem,gen)
  // }
  // if (this.state.recs.get(tag) === 'fantasy'){
  //   let elem = document.getElementById('hide1')
  //   let gen = document.getElementById('fantasy')
  //   genres(elem,gen)
  // } 
  // if (this.state.recs.get(tag) === 'romance'){
  //   let elem = document.getElementById("realistic")
  //   let gen = document.getElementById('romance')
  //   genres(elem,gen)
  // }
  // if (this.state.recs.get(tag) === 'history'){
  //   let elem = document.getElementById("realistic")
  //   let gen = document.getElementById('history')
  //   genres(elem,gen)
  // }
  // if (this.state.recs.get(tag) === 'mystery'){
  //   let elem = document.getElementById("realistic")
  //   let gen = document.getElementById('mystery')
  //   genres(elem,gen)
  // }
  // if (this.state.recs.get(tag) === 'adventure'){
  //   let elem = document.getElementById("realistic")
  //   let gen = document.getElementById('adventure')
  //   genres(elem,gen)
  // }
// }         
// if (tag === "subgenre"){
//   if (this.state.recs.get(tag) === 'alien'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('alien')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'AU'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('AU')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'dystopian'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('dystopian')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'apocalyptic'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('apocalyptic')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'tech'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('tech')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'time travel'){
//     let elem = document.getElementById("science fiction")
//     let gen = document.getElementById('time travel')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'horror'){
//     let elem = document.getElementById("fantasy")
//     let gen = document.getElementById('horror')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'folk'){
//     let elem = document.getElementById("fantasy")
//     let gen = document.getElementById('folk')
//     genres(elem,gen)
//   }
//   if (this.state.recs.get(tag) === 'witch'){
//     let elem = document.getElementById("fantasy")
//     let gen = document.getElementById('witch')
//     genres(elem,gen)
//   }
// }